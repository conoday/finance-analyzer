...
function PlanCard({ plan, selected, onClick }: {
  ...
  return (
    ...
    >
      {isSoon && (
        <span className="absolute top-2 right-2 text-[9px] px-1.5 py-0.5 rounded-full font-bold bg-slate-700 text-slate-800 border border-slate-600/50">
          Segera
        </span>
      )}
      ...
      <p className="text-[10px] text-slate-800 leading-snug">{meta.desc}</p>
      ...
      <div className="flex items-center gap-3 p-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5">
            <span className="text-sm font-semibold text-slate-800 truncate">{member.display_name}</span>
            {isMe && (
          ...
          {summary ? (
            ...
            <p className="text-[11px] text-slate-800 mt-0.5">Belum sync data</p>
          )}
        </div>
        <button
                    ...
                    <div className="flex-1 space-y-1">
                      {pieData.map((d, i) => (
                        <div key={d.name} className="flex items-center gap-1.5">
                          ...
                          <span className="text-[10px] text-slate-800 truncate flex-1">{d.name}</span>
...
function SharedBudgetTable({ room, isCreator, memberId }: {
  ...
  if (categories.length === 0) return (
    <div className="glass rounded-xl p-6 text-center text-slate-800 text-sm">
  ...
  return (
    <div className="glass rounded-xl overflow-hidden">
      <div className="flex items-center justify-between px-4 py-3 border-b border-white/[0.05]">
        <p className="text-xs font-semibold text-slate-800 uppercase tracking-wide">Budget Bersama</p>
        {!isCreator && <p className="text-[10px] text-slate-800">Hanya pembuat room yang bisa edit</p>}
      </div>
                  ...
                  editing === cat ? (
                    <div className="flex items-center gap-1">
                      <input
                        ...
                        className="w-24 text-xs px-2 py-0.5 rounded bg-slate-100 text-slate-800 outline-none border border-slate-300"
                        placeholder="0"
                      />
                      ...
                      <button onClick={() => setEditing(null)} className="text-slate-800 hover:text-slate-800">
  ...
  if (step === "idle") return (
    <div className="max-w-xl mx-auto space-y-5 py-4">
      <div className="text-center space-y-2">
        ...
        <h3 className="text-xl font-bold text-slate-800">Pantau keuangan bersama</h3>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          ...
          <span className="text-sm font-semibold text-slate-800">Buat Room</span>
        ...
        >
          ...
          <span className="text-sm font-semibold text-slate-800">Gabung Room</span>
      ...
      {/* plan tier preview */}
      <div>
        <p className="text-[10px] text-slate-800 mb-3 uppercase tracking-wide font-semibold">Pilihan Plan</p>
  ...
  if (step === "create") return (
    <div className="max-w-lg mx-auto space-y-5 py-4">
      <div className="flex items-center gap-2 mb-2">
        <button onClick={() => setStep("idle")} className="text-slate-800 hover:text-slate-800">
          <X className="w-4 h-4" />
        </button>
        <h3 className="text-base font-semibold text-slate-800">Buat Room Baru</h3>
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="w-full rounded-lg px-3 py-2 text-sm text-slate-800 bg-white/[0.06] border border-slate-200 outline-none focus:border-teal-500/50 transition-colors"
        />
      </div>
  ...
  if (step === "join") return (
    <div className="max-w-sm mx-auto space-y-4 py-4">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h3 className="text-base font-semibold text-slate-800">Gabung Room</h3>
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="w-full rounded-lg px-3 py-2 text-sm font-mono font-bold tracking-widest text-slate-800 bg-white/[0.06] border border-slate-200 outline-none focus:border-indigo-500/50 uppercase transition-colors"
          maxLength={8}
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="w-full rounded-lg px-3 py-2 text-sm text-slate-800 bg-white/[0.06] border border-slate-200 outline-none focus:border-indigo-500/50 transition-colors"
        />
      </div>
      ...
      <div className="glass rounded-xl p-4 flex flex-col sm:flex-row sm:items-center gap-4">
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <span className="text-[10px] text-slate-800">Bagikan ke anggota lain</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button onClick={() => fetchRoom(room.room_id)}
            className="p-1.5 rounded-lg text-slate-800 hover:text-slate-700 hover:bg-white transition-colors">
