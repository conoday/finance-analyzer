    ...
    >
      ...
      <div className="glass rounded-xl p-4 border border-white/[0.06]">
        <div className="flex items-center justify-between mb-3">
          <span className="text-xs font-semibold text-slate-800 uppercase tracking-wide">Pemasukan vs Pengeluaran</span>
          <span
        ...
        <div className="flex items-center gap-3 mb-2">
          <div className="flex items-center gap-1.5 min-w-0">
            ...
            <span className="text-xs text-slate-800 truncate">Masuk</span>
          ...
          <div className="flex items-center gap-1.5 min-w-0 ml-auto">
            ...
            <span className="text-xs text-slate-800 truncate">Keluar</span>
        ...
        {metrics.map((m) => (
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <div className="text-[11px] text-slate-700 mt-1 leading-snug truncate">{m.label}</div>
